...
/// 컨트롤러의 기본적인 포맷은 모두 비슷하다. 그렇기 때문에 컨트롤러에 대한 정형화된 틀을 만드는 것이 구현 중 실수를 방지할 때 유용할 것 같다.
class FavoriteRecipeListViewController:testController{
    
    private override func testMethod() {
